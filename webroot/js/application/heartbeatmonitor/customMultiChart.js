/**
 * Add ability to extend x domain with option 'forceX'
 * Add 'fixBar1' that fixes bar1 to show histogram better
 */
...
define(function(require) {
    ...
    nv.models.customMultiChart = function() {
        "use strict";
        ...
        function chart(selection) {
            selection.each(function(data) {
                ...
                if (forceX && forceX.length) {
                    x.domain(forceX).range([0, availableWidth]);
                } else {
                ...
                var ordinalScale = d3.scale
                    .ordinal()
                    .domain(d3.merge(data.map(function(d, idx) { return d.values.map(function(d,i) { return d.x; }); })).sort())
                    .rangeBands([0, availableWidth], 0);

                if (fixBar1) {
                    bars1.xRange([0, availableWidth + ordinalScale.rangeBand()]);
                }
        ...
        chart._options = Object.create({}, {
            ...
            fixBar1:  {get: function(){return fixBar1;}, set: function(_){fixBar1=_;}},
    ...
    return nv.models.customMultiChart;
});
